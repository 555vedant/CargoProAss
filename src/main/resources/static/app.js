    ...
    try {
        ...
        loads.forEach(load => {
            ...
            row.innerHTML = `
                ...
                <td><button class="delete-btn" onclick="deleteLoad('${load.id}')">Delete</button></td>
            `;
    ...
    try {
        const load = {
            ...
            facility: {
                ...
                loadingDate: new Date(document.getElementById('loadingDate').value).toISOString(),
                unloadingDate: new Date(document.getElementById('unloadingDate').value).toISOString()
            },
...
async function createBooking(event) {
    ...
    try {
        ...
        alert('Failed to create booking. Please ensure the Load ID is valid and try again.');
    }
}
